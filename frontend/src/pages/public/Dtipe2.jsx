...
export default function Dtipe2() {
    return (
                    ...
                    <div className="space-y-6 col-span-2">
                        <div className="bg-white rounded-lg shadow-lg overflow-hidden relative">
                            ...
                            <p className="p-2 text-xs text-white bg-blue-900/80 absolute bottom-0 left-0 w-full">
                                Tampak Bus Eksterior Surya Kencana Tipe 2
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-lg shadow-lg overflow-hidden relative">
                            ...
                            />
                            <p className="p-2 text-xs text-white bg-blue-900/80 absolute bottom-0 left-0 w-full">
                                Tampak Tempat Duduk Bus Surya Kencana Tipe 2
                            </p>
                        </div>
                        ...
                        <div className="bg-white rounded-lg shadow-lg overflow-hidden relative">
                            ...
                            />
                            <p className="p-2 text-xs text-white bg-blue-900/80 absolute bottom-0 left-0 w-full">
                                Tampak Makanan Bus Eksterior Surya Kencana Tipe 2
                            </p>
                        </div>
                    </div>
